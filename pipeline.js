...
## 专业名词解释词典（放在末尾，标题必须严格使用「## 专业名词解释词典」，不得改动）
识别所有有理解门槛的概念（经济学/社会学效应、数学/物理概念、哲学概念、行业术语、嘉宾自创概念）。
每个术语严格按以下格式输出，不得遗漏任何字段：
**[名词]**（[英文/原文]）出处。通俗解释2-3句。嘉宾自创概念标注「嘉宾定义」。

⚠️ 格式警告：「## 专业名词解释词典」这个标题是下游系统解析的锚点，必须一字不差地输出。不要写成「模块C」「术语词典」「名词解释」等任何变体。
